...
import intro00 from "../../assets/images/intro01.png";
        ...
        <>
          <div className="section02">
            <div className="text-wrap">
              ...
              <p className="p3">
                ...
                수사경험이 풍부한 검사장 출신 변호사,  민∙형사 재판 업무를
                30여년 간 담당했던 변호사 등이 주축이 되어 수사단계부터 재판에
                이르기까지
          ...
          <div className="section04">
            ...
            <div className="text-wrap">
              ...
              <p className="p3">
                이미 문제가 발생한 후에 대응하는 것만으로는
                부족합니다. 준법경영에 필요한{" "}
                <span className="bold">내부통제시스템</span>을 갖추고, 끊임없이
                체크하며 <span className="bold">문제를 예방</span>
                해야 합니다. 
                <br />
                <br /> LawVax는 법률(Law)과 백신(Vax∙Vaccine의 줄임말)의
                합성어로써,  로펌이 출범할 때부터{" "}
                <span className="bold">‘기업의 법률백신’</span>이 되겠다는
                포부를 담았습니다.  사명과 같이 기업이 당면할 사법리스크를 미리
                진단하고 이를 해결하기 위한 최적의 솔루션을 제시하겠습니다. 
              </p>
            </div>
          </div>
        </>
