    ...
    <div className="support-center-page">
      ...
      <div className="theme-select">
        ...
        <button
          ...
          onClick={() => setActiveTab("서비스소개")}
        >
          서비스 소개
        </button>
        <button
          className={activeTab === "조직도" ? "active" : ""}
          onClick={() => setActiveTab("조직도")}
        >
          조직도
        </button>{" "}
        <button
      ...
      <div className="section01">
        ...
        <div className="text-wrap">
          ...
          <p className="p2">
            ...
            <br />
            <br />
            지원센터는 <span className="bold">검찰의 중요 수사부서 책임자</span>
            ...
            <span className="bold">지배구조 및 ESG 전문가</span>인 조명현 고려대
            경영대 교수,
            <br />
            김대지 전 <span className="bold">국세청장</span>, 천홍욱 전
            <span className="bold">관세청장</span>은 자문위원으로서 업무 전반에
            대하여 자문해 주고 있습니다.
            <br />
            <br />
            <span className="bold">
        ...
        <div className="content">
          ...
          <div className="text-wrap">
            ...
            <p className="p2">
              ...
              기업 내 엄격한 내부통제 시스템의 구축 필요성이 절실한 시점입니다.
              <br />
        ...
        <div className="content">
          <div className="text-wrap">
            ...
            <p className="p2">
              ...
              감사를 진행할 수 있습니다.     <br />
              <br />△ 감사업무 종료 시, 기업의 요청에 따라 감사 결과를 서면으로
              제공하고, 필요한 경우 고소·고발장, 소장 작성 등의 업무도 수행하게
              됩니다.   <br />
              <br />
              2. 내부통제 시스템 구축 자문     <br />
              <br />△ 판례에서 요구하는 ‘내부통제 시스템 구축의무’에 부합할만한
              시스템을 구축하여 대비하고 있는 기업은 많지 않습니다.      
              <br />- 지금까지는 주로 담합이나 분식회계 관련 사안이
              문제되었으나, 앞으로는 중대재해 처벌법, 개인정보보호법, 자본시장법
              등과 관련된 이슈 등도 문제될 것으로 예상됩니다.     <br />
              <br />△ LawVax의 컨설팅을 통해 합리적이고 효율적인 내부통제
              시스템을 구축할 수 있습니다.       <br />① 부서별 업무 및 관련
              규정을 검토하여 임직원이 준수해야 할 내부통제 기준을 수립하고,
              <br />② 임직원이 내부통제 기준을 숙지하고 이를 준수하도록 정기적인
              교육을 실시하며, <br />③ 모니터링 시스템을 구축하고, <br />④
              위법·부당행위 적발 시 이사회에 보고하여 위반직원에 대한 제재와
              시정을 요구하는 등 내부통제 시스템을 구축할 수 있습니다.
            </p>
          </div>
          <div className="img-wrap">
        ...
        <div className="content">
          ...
          <div className="text-wrap">
            <p className="p2">
              ...
              <br />△ 조사 결과는 내부통제 시스템 개선 자료로 활용할 수 있으며,
              위 조사 과정에서 풍부한 회계 부정 조사 경험과 전문성을 보유한 법률
              전문가 등의 조력을 받는 것은 매우 중요합니다.     <br />
              <br />
              4. 산업기술보호 등과 관련된 법률 리스크에 대한 자문     <br />
              <br />△ 국가핵심기술·방산기술·전략물자의 해외 수출 및 외국
              기업과의 M&A 관련 정부의 승인·신고 절차에 대하여 국가정보기관 출신
              기술보호 전문가들의 컨설팅을 제공합니다.     
              <br />
        ...
        <div className="content">
          <div className="text-wrap">
            ...
            <p className="p2">
              ...
              <br />
              <br />
              2. 그 외에도 회사나 공공기관 경영진의 요청에 따라 내부 비리에 대한
              감사를 다수 수행하였습니다.   <br />
              <br />
              3. 지원센터 소속 전문위원인 공인회계사나 세무사들은 M&A 피인수
              기업의 조사에 참여한 경험이 많습니다.     
              <br />
              <br />△ 피인수법인 A사(전자제품 제조 및 판매회사)의 제품불량 이슈
              확인 사례       <br />
              <br />△ 피인수법인 B社(식품 제조 및 판매회사)의 영업이익 과대계상
              내역 확인 사례     <br />
